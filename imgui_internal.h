...
//#endif
    ...
    IMGUI_API bool          TabButtonEx(const char* ico, const char* label, bool selected = true, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0);
    IMGUI_API bool          OptButtonEx(const char* ico, const ImVec2& size_arg = ImVec2(0, 0), const ImVec2& cursor_pos = ImVec2(0, 0), bool rotation = false, ImGuiButtonFlags flags = 0);
