...
namespace ImGui
{
    ...
    bool                    Sub_TabButtonEx(const char* label, bool selected, bool rect, const ImVec2& size_arg, ImGuiButtonFlags flags);
    // button
    IMGUI_API bool          Sub_TabButton(const char* label, bool selected, bool rect, const ImVec2& size_arg = ImVec2(0, 0));
    IMGUI_API bool          TabButton(const char* ico, const char* label, bool selected = true, const ImVec2& size = ImVec2(0, 0));   // button
    IMGUI_API bool          OptButton(const char* ico, const ImVec2& size = ImVec2(0, 0), const ImVec2& cursor_pos = ImVec2(0, 0), bool rotation = false);   // button
